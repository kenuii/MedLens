...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2C333F);
  late Color secondary = const Color(0xFF709DAF);
  late Color tertiary = const Color(0xFF189ED4);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF2C333F);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFF709DAF);
  late Color accent1 = const Color(0xFF189ED4);
  late Color accent2 = const Color(0xFFF83938);
  late Color accent3 = const Color(0xFFC1CFDA);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFF2C333F);
}
